...
public class Article {
    ...
    public void save() {
        ...
        if (null == myDao) {
            myDao = DaoHelper.getDaoSession().getArticleDao();
        }
