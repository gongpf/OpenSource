...
public class Article {
    ...
    public List<ArticleImage> getImage() {
        if (image == null) {
            ...
            ArticleImageDao targetDao = daoSession.getArticleImageDao();
    ...
    public List<ArticleThumbnail> getThumbnails() {
        if (thumbnails == null) {
            ...
            ArticleThumbnailDao targetDao = daoSession.getArticleThumbnailDao();
