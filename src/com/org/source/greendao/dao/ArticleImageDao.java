...
public class ArticleImageDao extends AbstractDao<ArticleImage, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Aid = new Property(10, long.class, "aid", false, "AID");
    };
    ...
    protected void bindValues(SQLiteStatement stmt, ArticleImage entity) {
        ...
        stmt.bindLong(11, entity.getAid());
    }
    ...
    public void readEntity(Cursor cursor, ArticleImage entity, int offset) {
        ...
        entity.setAid(cursor.getLong(offset + 10));
     }
    ...
    public List<ArticleImage> _queryArticle_Image(long aid) {
        synchronized (this) {
