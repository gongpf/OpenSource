...
import com.org.source.jackson.databind.ser.ContainerSerializer;
import com.org.source.jackson.databind.ser.ContextualSerializer;
                ...
                for (Enum<?> enumValue : enumClass.getEnumConstants()) {
                    ...
                    JsonNode schemaNode = (ser instanceof SchemaAware) ?
                            ((SchemaAware) ser).getSchema(provider, null) :
                            	com.org.source.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
