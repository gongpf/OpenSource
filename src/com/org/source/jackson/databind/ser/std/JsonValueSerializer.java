...
import com.org.source.jackson.databind.ser.BeanSerializer;
import com.org.source.jackson.databind.ser.ContextualSerializer;

/**
 * Serializer class that can serialize Object that have a
 * {@link com.org.source.jackson.annotation.JsonValue} annotation to
    ...
    implements ContextualSerializer, JsonFormatVisitable, SchemaAware
{
     ...
     *    {@link com.org.source.jackson.databind.annotation.JsonSerialize#using}), otherwise
     *    null
     */
...
//            TypeSerializer typeSer = new TypeSerializerWrapper(typeSer0, bean);
        ...
        throws JsonMappingException
    {
        ...
        return com.org.source.jackson.databind.jsonschema.JsonSchema.getDefaultSchemaNode();
    }
