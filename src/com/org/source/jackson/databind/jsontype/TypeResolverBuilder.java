package com.org.source.jackson.databind.jsontype;

import java.util.Collection;

import com.org.source.jackson.annotation.JsonTypeInfo;
import com.org.source.jackson.annotation.JsonTypeInfo.As;
import com.org.source.jackson.databind.DeserializationConfig;
import com.org.source.jackson.databind.JavaType;
import com.org.source.jackson.databind.SerializationConfig;

/**
 * Interface that defines builders that are configured based on
 * annotations (like {@link com.org.source.jackson.annotation.JsonTypeInfo} or JAXB annotations),
...
public interface TypeResolverBuilder<T extends TypeResolverBuilder<T>>
{
     ...
     * defaults for {@link com.org.source.jackson.annotation.JsonTypeInfo.Id} configured.
     * 
     ...
     * {@link com.org.source.jackson.databind.JsonDeserializer}s or not.
     * 
     * @return Resulting builder instance (usually this builder,
     *   but may be a newly constructed instance for immutable builders}
     * 
