...
import com.org.source.jackson.databind.deser.BeanDeserializerModifier;
import com.org.source.jackson.databind.deser.DeserializationProblemHandler;
import com.org.source.jackson.databind.deser.Deserializers;
import com.org.source.jackson.databind.deser.KeyDeserializers;
import com.org.source.jackson.databind.deser.ValueInstantiators;
...
import com.org.source.jackson.databind.ser.BeanSerializerModifier;
import com.org.source.jackson.databind.ser.Serializers;
import com.org.source.jackson.databind.type.TypeFactory;
import com.org.source.jackson.databind.type.TypeModifier;
    ...
    implements Versioned
{
    ...
    public static interface SetupContext
    {
        ...
        /**
         * Method that module can use to register additional
         * {@link TypeModifier} instance, which can augment {@link com.org.source.jackson.databind.JavaType}
         * instances constructed by {@link com.org.source.jackson.databind.type.TypeFactory}.
         * 
        ...
        /**
         * Method that module can use to register additional {@link com.org.source.jackson.databind.deser.ValueInstantiator}s,
         * by adding {@link ValueInstantiators} object that gets called when 
         * instantatiator is needed by a deserializer.
         * 
         * @param instantiators Object that can provide {@link com.org.source.jackson.databind.deser.ValueInstantiator}s for
