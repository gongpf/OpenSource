...
public class ArticleDao extends AbstractDao<Article, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Valid = new Property(19, Boolean.class, "valid", false, "VALID");
    };
    ...
    public Article readEntity(Cursor cursor, int offset) {
        Article entity = new Article( //
            ...
            cursor.isNull(offset + 19) ? null : cursor.getShort(offset + 19) != 0 // valid
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Article entity, int offset) {
        ...
        entity.setValid(cursor.isNull(offset + 19) ? null : cursor.getShort(offset + 19) != 0);
     }
