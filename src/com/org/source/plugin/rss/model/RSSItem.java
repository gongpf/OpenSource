...
public class RSSItem extends Model {
    ...
    public RSSItem(RSSData rssData, String des, String time, String url,
            String text) {
        super();
    ...
    public static RSSItem save(RSSData rssData, String des, String time,
            String url, String text) {
        RSSItem data = new Select().from(RSSItem.class)
                .where("description = ?", des).executeSingle();
